...
function init(){
    ...
    style.innerHTML = '.mg-debug-panel{box-sizing:border-box;position: fixed;'+
        ...
        'overflow:auto;height:5.5rem;overflow:auto;'+
        'background:#fff;color:#262626;}'+
        '.mg-debug-toggle{border-radius:5px;position:absolute;right:0;top:-.4rem;height:.6rem;line-height:.5rem;'+
        'font-size:12px;width:1.5rem;text-align:center;background:#fff;color:#000;box-shadow:0 -10px .3rem rgba(0,0,0,.2);}'+
